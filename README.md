...
1. Before making calls, also make sure that you give the caller and callee E164 Number values. You can do so by going to "Settings > Subscriber", find the subscriber and click "Details", and then under "Master Data" click "Edit" enter E164 number (for example 43 12 3456) and click save
