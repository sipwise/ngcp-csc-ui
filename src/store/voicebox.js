...
export default {
    namespaced: true,
    state: {
        // TODO: States for all the update actions
        // TODO: States for all the update action errors
        // TODO: Test with voiceboxSetting: null once done
        voiceboxSettings: {
            attach: false,
            delete: false,
            email: '',
    ...
    getters: {
        ...
        voiceboxPin(state) {
            return _.get(state.voiceboxSettings, 'pin', '');
        },
        voiceboxEmail(state) {
            return _.get(state.voiceboxSettings, 'email', '');
        },
        deleteLabel(state) {
        ...
        isPinFailed(state) {
            return state.updatePinState === 'failed';
        },
        isEmailFailed(state) {
            return state.updateEmailState === 'failed';
        }
    },
    mutations: {
