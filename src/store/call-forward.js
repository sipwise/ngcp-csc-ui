...
export default {
    ...
    actions: {
        ...
        changePositionOfDestination(context, options) {
            ...
            // TODO: needs to be expanded to also splice move the destination
            // upwards or downwards one index position
            clonedDestinations[options.index].priority = adjacentPriority;
