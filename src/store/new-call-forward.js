...
export default {
    ...
    mutations: {
        ...
        editDestination(state, data){
            ...
            destination.simple_destination =  data.simple_destination;
    ...
    actions: {
        ...
        async addDestination(context, data){
            try{
                const destination = {
                    ...
                    "destination": 'sip:' + data.destination + '@localhost:8080', // TODO take url
                    "priority": 1,
        ...
        async editDestination(context, data){
            let destination = context.destinations.slice(data.index, data.index+1)[0];
            destination.simple_destination =  data.simple_destination;
            destination.destination =  data.destination;
