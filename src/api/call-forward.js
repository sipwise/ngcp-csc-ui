...
// TODO: 1. Handle cases where group has no previous destination
// DONE: a. Create addNewDestinationset()
// DONE: b. Create addDestinationsetToEmptyGroup() where you're chaining
//          addNewDestinationset() and addDestinationToDestinationset() to
//          first create a new destinationset and then add destination to that
//          newly created destinationset
// TODO: c. Also need to create mapping, so create addNewMapping, and chain in
//          getMappings and addNewMapping
