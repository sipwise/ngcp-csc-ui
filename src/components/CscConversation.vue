    ...
    <q-card class="conversation-card" :id="conversation._id">
        ...
        <div v-if="!isFax(conversation.type)">
            ...
            <q-card-actions align="center">
                ...
                <audio id="vr1" ref="voicemailsound" @timeupdate="timeupdate($event)">
                <!--<audio ref="voicemailsound" @timeupdate="timeupdate($event)">-->
                    <!--<source :src="voicemailRecording" type="audio/x-wav" />-->
                </audio>
                <button @click="loadVoicemail()" style="width:100px;">CLICK</button>
                <!--<input v-model="voicemail">-->
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            //,voicemailRecording() {
            //    return this.voicemail = this.$store.state.conversations.voicemailRecording;
            //}
        },
        methods: {
            loadVoicemail() {
                this.$refs.voicemailsound.src = this.$store.state.conversations.voicemailRecording;
            },
            ...
            playVoicemail() {
                ...
                //console.log(this.$refs.voicemailsound);
