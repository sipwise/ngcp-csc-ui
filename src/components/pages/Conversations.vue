    ...
    export default {
        ...
        methods: {
            call(conversation, localMedia) {
                console.log('call()');
                // NOTE: Tried with number as string, number and with + prefix.
                // call/start gets dispatched, but nothing happens in UI, and I
                // see no call related debug messages
                //this.$store.dispatch('call/start',
                //    { number: '43993007', localMedia: localMedia });
