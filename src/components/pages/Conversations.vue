<template>
	...
	<q-card v-for="conversation in conversations" :key="conversation.caller" class="conversation-card">
		<q-collapsible icon="call" v-bind:label="getCollapsibleLabel(conversation)" sublabel="May 2, 2017 at 9:53 pm">
 		  <div>
            <ul>
...
<script>
    ...
    // TODO: 1. Import Moment.js and parse date for sublabel
    // TODO: 2. Implement custom q-card-collapsible that has two icon attributes
    // TODO: 3. Create events and actions for buttons where applicable
    // TODO: 4. Styling in general
