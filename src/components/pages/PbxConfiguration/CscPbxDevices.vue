    ...
    >
        <div
            ...
            <q-btn
                ...
                color="primary"
                @click="toggleFilter()"
            >{{ $t('pbxConfig.filterDevices') }}</q-btn>
            <q-btn
                v-if="filterEnabled"
                flat
                icon="clear"
        ...
        <div v-if="filterEnabled" class="row justify-center items-center margin-xs">
            <q-field
        ...
        <div class="row justify-center margin-xs">
