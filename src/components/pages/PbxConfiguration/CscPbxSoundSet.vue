    ...
    >
        ...
        <q-item-main>
            ...
            >
                ...
                >
                    <q-inner-loading :visible="nameRequesting">
                        <q-spinner-dots
                            color="primary"
                            :size="24"
                        />
                ...
                >
                    <q-inner-loading :visible="descriptionRequesting">
                        <q-spinner-dots
                            color="primary"
                            :size="24"
                        />
                ...
                >
                    <q-inner-loading :visible="contractDefaultRequesting">
                        <q-spinner-dots
                            color="primary"
                            :size="24"
                        />
                    ...
                    <q-toggle
                        ...
                        :disable="contractDefaultRequesting"
...
<script>
    ...
    export default {
        ...
        props: {
            ...
            mobile: Boolean,
            loading: Boolean,
            nameRequesting: Boolean,
            descriptionRequesting: Boolean,
            contractDefaultRequesting: Boolean
        },
        components: {
            CscPbxSoundGroup,
            QItem,
