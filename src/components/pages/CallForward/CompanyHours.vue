...
<script>
    ...
    export default {
        data () {
            return {
                // NOTE: These vm values are needed to be able to toggle
                // back q-alert visibility after dismiss/actions. Can not
                // be instantiated with false, and not shared across
                // several q-alerts, so need v-if wrapper to ultimately
                // control visibilty in our use case
