...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            unavailGreetingLoaded() {
                return this.playGreetingLoaded(this.unavailGreetingId);
            },
            soundFileFormat() {
        ...
        methods: {
            ...
            playBusyGreeting() {
                this.$store.dispatch('voicebox/playBusyGreeting', {
                    id: this.busyGreetingId,
                    format: this.soundFileFormat
                });
            },
            playUnavailGreeting() {
                this.$store.dispatch('voicebox/playUnavailGreeting', {
                    id: this.unavailGreetingId,
                    format: this.soundFileFormat
                });
            },
