        ...
        methods: {
            ...
            blockedIncoming(item) {
                if (item.direction === 'out') {
                    return this.callerIsBlockedIncoming(item.callee);
                }
                else {
                    return this.callerIsBlockedIncoming(item.caller);
                }

            },
            blockedOutgoing(item) {
                if (item.direction === 'out') {
                    return this.callerIsBlockedOutgoing(item.callee);
                }
                else {
                    return this.callerIsBlockedOutgoing(item.caller);
                }
            }
        },
        watch: {
