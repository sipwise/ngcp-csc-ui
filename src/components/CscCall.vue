        ...
        <q-card flat color="secondary">
            ...
            <q-card-main>
                ...
                <div class="csc-call-media">
                    <csc-media :class="mediaPreviewClasses" id="local-media" v-show="isCalling" :stream="localMediaStream" />
                    <csc-media class="csc-media-remote" id="remote-media" v-show="isEstablished" :stream="remoteMediaStream" />
                </div>
