...
import PbxConfigurationManagerSecretary from './components/pages/PbxConfiguration/CscPbxManagerSecretary'
...
export default [
    {
        ...
        children: [
            ...
            {
                path: 'pbx-configuration/manager-secretary',
                component: PbxConfigurationManagerSecretary,
                meta: {
                    title: i18n.t('navigation.pbxConfiguration.title'),
                    subtitle: i18n.t('navigation.pbxConfiguration.managerSecretary')
                }
            },
            {
                path: 'voicebox',
